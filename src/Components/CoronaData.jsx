...
function CoronaData() {
	...
	return (
		<div className="covidData">
			<center><h1>COVID-19 CASES COUNTRY WISE</h1></center>
			<div className="covidData__input">
				<form onSubmit={handleSubmit}>
					...
					<center><button type="submit" style={{placeItems:"center"}}>Search</button></center>
				</form>
			</div>

			{/* Showing the details of the country */}
			<div className="covidData_country_info">
